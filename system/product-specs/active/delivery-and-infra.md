...
- [test-harness-reliability](./test-harness-reliability.md) — caplog
  pollution diagnosis tooling (bisect script) and regression guards
  that keep the full suite deterministic.
...
- coder-core-modular-monolith — coder-core modular monolith hardening (shipped 2026-04-26 as WIP 0051; promoted to active subject-slug on 2026-05-03).
  ...
  services.
- **0091** (2026-05-14) — Added `test-harness-reliability` component.
  Bisect script + regression tripwire for caplog pollution; four
  previously-skipped tests restored; response to the 2026-05-13
  prod-recovery incident.
...
- Related components: [tenant-isolation](./tenant-isolation.md),
  [test-harness-reliability](./test-harness-reliability.md),
