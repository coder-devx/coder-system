...
- **Branch capture is best-effort.** Only `task/*` branches land in
  `tasks.branch_name`; the [branch-cleanup](../pipeline/branch-cleanup.md) GC
...
- **System prompt path:** `system/roles/developer/role.md` +
  `system/roles/developer/tasks/implement.md` (per [design 0057](./role-prompt-knowledge-layout.md)).
