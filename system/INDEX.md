...
- [escalations](./product-specs/active/escalations.md) (spec) · [escalations](./designs/active/pipeline/escalations.md) (design) — Three-rung on-call ladder with quiet hours.
...
- [self-healing](./product-specs/active/self-healing.md) (spec) · [self-healing](./designs/active/pipeline/self-healing.md) (design) — Reaper for stuck tasks past timeout.
...
- [architect-worker](./product-specs/active/architect-worker.md) (spec) · [architect-worker](./designs/active/workers/architect-worker.md) (design) — Software Architect worker — designs, ADRs, and system shape.
- [developer-worker](./product-specs/active/developer-worker.md) (spec) · [developer-worker](./designs/active/workers/developer-worker.md) (design) — Developer worker — code, tests, PRs.
- [pm-worker](./product-specs/active/pm-worker.md) (spec) · [pm-worker](./designs/active/workers/pm-worker.md) (design) — Product Manager worker — owns specs and acceptance.
- [reviewer-worker](./product-specs/active/reviewer-worker.md) (spec) · [reviewer-worker](./designs/active/workers/reviewer-worker.md) (design) — Reviewer worker — technical-quality gate before PM acceptance.
...
- [team-manager-worker](./product-specs/active/team-manager-worker.md) (spec) · [team-manager-worker](./designs/active/workers/team-manager-worker.md) (design) — Team Manager worker — decomposes specs into developer tasks.
...
- [audit-log](./product-specs/active/audit-log.md) (spec) · [audit-log](./designs/active/tenancy/audit-log.md) (design) — Every mutation recorded with actor, action, before, after.
...
- [impersonation](./product-specs/active/impersonation.md) (spec) · [impersonation](./designs/active/tenancy/impersonation.md) (design) — Short-lived role-scoped bearer tokens for worker actions.
...
- [multi-tenancy](./product-specs/active/multi-tenancy.md) (spec) · [multi-tenancy](./designs/active/tenancy/multi-tenancy.md) (design) — project_id everywhere invariant — no cross-tenant data access.
...
- [service-accounts](./product-specs/active/service-accounts.md) (spec) · [service-accounts](./designs/active/tenancy/service-accounts.md) (design) — Per-role GCP service accounts and brokered escalations.
...
- [admin-panel](./product-specs/active/admin-panel.md) (spec) · [admin-panel](./designs/active/knowledge/admin-panel.md) (design) — User-facing SPA for status, debug, override.
- [cold-start-ingestion](./product-specs/active/cold-start-ingestion.md) (spec) · [cold-start-ingestion](./designs/active/knowledge/cold-start-ingestion.md) (design) — Bootstrap a new project's knowledge from existing repos.
...
- [knowledge-freshness](./product-specs/active/knowledge-freshness.md) (spec) · [knowledge-freshness](./designs/active/knowledge/knowledge-freshness.md) (design) — Automatic stale-artifact detection and rewrites.
...
- [onboarding](./product-specs/active/onboarding.md) (spec) · [onboarding](./designs/active/knowledge/onboarding.md) (design) — How a new project gets wired into Coder.
...
- [continuous-deployment](./product-specs/active/continuous-deployment.md) (spec) · [continuous-deployment](./designs/active/delivery/continuous-deployment.md) (design) — Push-to-main CD with health checks.
- [tenant-isolation](./product-specs/active/tenant-isolation.md) (spec) · [tenant-isolation](./designs/active/delivery/tenant-isolation.md) (design) — Test-suite harness for the multi-tenancy contract.
